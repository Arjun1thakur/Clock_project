...
function alerm(){
    ...
    if(wake_up.value!='Default'){
        ...
        if(hour==wake[0] && ok==wake[1]){
            main_img2.src = 'img/Component\ 30\ –\ 1@2x.png';
        }else{
            main_img2.src = 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg';
        }
    }else if(lunch.value!='Default'){
        title_set.innerHTML = "GOOD AFTERNOON !! TAKE SOME SLEEP";
        // main_img.style.backgroundImage = 'url(img/Component\ 31\ –\ 1.svg)'
        if(hour==lun[0] && ok==lun[1]){
            main_img2.src = 'img/Component\ 31\ –\ 1.svg';
        }else{
            main_img2.src = 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg';
        }
        ...
        if(hour==nape[0] && ok==nape[1]){
            main_img2.src = 'img/lunch_image@2x.png';
        }else{
            main_img2.src = 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg';
        }
        ...
        if(hour==nigh[0] && ok==nigh[1]){
            main_img2.src = 'img/Component\ 32\ –\ 1@2x.png';
        }else{
            main_img2.src = 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg';
        }
    }
        ...
        // main_img.style.backgroundImage = 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg'
        main_img2.src = 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg';
    }
}
